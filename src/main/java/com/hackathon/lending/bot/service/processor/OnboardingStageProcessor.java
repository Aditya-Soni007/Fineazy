...
@Component
public class OnboardingStageProcessor extends BaseStageMessageProcessor {
    
    public OnboardingStageProcessor() {
        super(ApplicationStages.StageType.ONBOARDING);
    }

    private static final Logger log = LoggerFactory.getLogger(OnboardingStageProcessor.class);
