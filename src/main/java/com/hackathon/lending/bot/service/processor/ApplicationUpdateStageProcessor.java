...
public class ApplicationUpdateStageProcessor extends BaseStageMessageProcessor {
    
    public ApplicationUpdateStageProcessor() {
        super(ApplicationStages.StageType.APPLICATION_UPDATE);
    }

    private static final Logger log = LoggerFactory.getLogger(ApplicationUpdateStageProcessor.class);
