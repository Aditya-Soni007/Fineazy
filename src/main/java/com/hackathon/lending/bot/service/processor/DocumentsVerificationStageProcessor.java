...
@Component
public class DocumentsVerificationStageProcessor extends BaseStageMessageProcessor {
    
    public DocumentsVerificationStageProcessor() {
        super(ApplicationStages.StageType.DOCUMENTS_VERIFICATION);
    }

    private static final Logger log = LoggerFactory.getLogger(DocumentsVerificationStageProcessor.class);
